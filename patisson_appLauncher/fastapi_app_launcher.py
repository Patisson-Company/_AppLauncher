...
class BaseFastapiAppLauncher(BaseAppLauncher):
    ...
    def add_token_middleware(self, get_token: Callable[..., Awaitable[str]],
        ...
        class AuthMiddleware(BaseHTTPMiddleware):
            ...
            def __init__(self, app: ASGIApp, excluded_paths: Collection[str]):
                super().__init__(app)
    ...
    def add_jaeger(self, add_validation_exception_handler: bool = True,
        ...
        Args:
            ...
            validation_exception_handler (Optional[ExceptionHandler]): Custom handler for validation exceptions.
        """
